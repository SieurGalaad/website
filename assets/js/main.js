...
(() => {
  ...
  function brancherPoussiere() {
    ...
    const semer = (c) => {
      ...
      /* Le calque couvre désormais toute la section : sur un écran large,
         70 grains se perdaient. Le plafond suit la surface réellement
         couverte, sans jamais dépasser 120 par calque (au-delà, on paie du
         calcul pour un effet que l'œil ne distingue plus). */
      const nombre = Math.round(Math.min(120, r.width / diviseur));
